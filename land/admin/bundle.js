...
function get_pahes_list() {
  ...
  $.get('./api', function (data) {
    ...
    data.forEach(function (element, index) {
      $('body').append("<h1>".concat(element, "</h1>"));
    });
  }, 'JSON');
}
